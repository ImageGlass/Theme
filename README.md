...
💡 For full example of `igtheme.json` file, please refer to [dark/Green-Gradient.Duong-Dieu-Phap/igtheme.json](https://github.com/ImageGlass/Theme/blob/main/themes/dark/Green-Gradient.Duong-Dieu-Phap/igtheme.json).
